...
import { deleteDoctor } from "../../api/AdminApi"
...
export default function DeleteDoctorModal() {
    ...
    const deleteDoctorId=queryParams.get('deleteDoctor')!
    const show = deleteDoctorId?true:false
    ...
    const handleDeleteDoctor=()=>mutate(deleteDoctorId)
                        ...
                        <div className="flex min-h-full items-center justify-center p-2 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-6">
                                    ...
                                    <p className="text-lg font-semibold">Are you sure to delete the doctor?
                                    </p>

                                    <form
                                        className='mt-10 flex gap-4 justify-end'
                                        onSubmit={handleSubmit(handleDeleteDoctor)}
                                        noValidate
                                    >
                                        <input
                                            type="submit"
