...
import { RequestConfirmationCodeAffiliate } from "../../types";
import { useMutation } from "@tanstack/react-query";
import { requestConfirmationCode } from "../../api/AuthAffiliateAPI";
import { toast } from "react-toastify";

export default function RequestNewCodeAffiliateView() {
    const initialValues: RequestConfirmationCodeAffiliate = {
        email:""
    }
    const {register,handleSubmit,formState:{errors}}=useForm<RequestConfirmationCodeAffiliate>({defaultValues:initialValues})
    ...
    const handleRequestCode = (formData:RequestConfirmationCodeAffiliate)=>mutate(formData)
