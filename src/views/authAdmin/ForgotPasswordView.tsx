...
import { forgotPassword } from "../../api/AuthAdminAPI";
...
export default function ForgotPasswordView() {
    ...
    const {register,reset,handleSubmit,formState:{errors}}=useForm<ForgotPasswordForm>({defaultValues:initialValues})
    ...
    const handleRequestCode=(formData:ForgotPasswordForm)=>mutate(formData)
